...
module.exports = {
  ...
  async run(client, message, args) {
    ...
    kl.add(message.author.id + ".kadin", 1)
    kb.set(kullanici.user.id + ".cinsiyet", "Kadın")
    ...
    kb.push(kullanici.user.id + ".kayitlar", { isim: isim, yas: yas, cinsiyet: "Kadın" })
    var tarih = new Date();
    ...
    var rol_mesaji = ""
    if (typeof k1 !== "undefined") rol_mesaji += `<@&${k1.id}>, `
    if (typeof k2 !== "undefined") rol_mesaji += `<@&${k2.id}>, `
    if (typeof k3 !== "undefined") rol_mesaji += `<@&${k3.id}>, `
    ...
    try {
      if (typeof e1 !== "undefined") if (!kullanici.roles.cache.get(ayarlar.erkek_1)) await kullanici.roles.add(k1)
      ...
      if (typeof k1 !== "undefined") if (kullanici.roles.cache.get(ayarlar.kadin_1)) kullanici.roles.remove(e1)
      if (typeof e1 !== "undefined") if (!kullanici.roles.cache.get(ayarlar.erkek_1)) kullanici.roles.add(k1)
